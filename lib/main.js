// TODO use Gpml2pvjson to convert GPML/XML to pvjson
...
function WikipathwaysApiClient(args) {
  ...
  var prefixedGpml = '<?xml version="1.0" encoding="UTF-8"?>'.concat(e.gpml);
  
  var pathData = {
    pwId: args.identifier,
    description:"Quick edit by pvjs",
  ...
  $.ajax({
    url: URI(baseIri).filename("index.php"),
    type:"post",
    data:pathData,
    ...
    error: function(xhr,stat,err){
      console.log("Fail: "+ stat + "ERROR" + err);
      return false;
    }
  });
