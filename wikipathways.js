...
(function () {
  ...
  // Create a safe reference to the Wikipathways object for use below.
  var Wikipathways = function(obj) {
    if (obj instanceof Wikipathways) {
      return obj;
    }
    if (!(this instanceof Wikipathways)) {
      return new Wikipathways(obj);
    }
  };
        ...
        var callbackOnGettingPathway = function(response) {
          ...
          response.on('end', function () {
            if (mediaTypeToJqueryDataTypeMappings[mediaType] === 'json') {
              ...
              callback(null, gpmlPathwaySelection);
            } else {
              callback(null, str);
            }
          });
  ...
  if (typeof exports !== 'undefined') {
    ...
    root.Wikipathways = Wikipathways;
  }
})();
